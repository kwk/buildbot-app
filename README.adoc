...
link:#0995653e-094e-4c2f-80e2-0fb04776718e[Listing 1. ]Command structure
(../cmd/buildbot-app/command/command.go) +
link:#7f23b34d-b2a7-410e-84e5-e0c7d4cac4b2[Listing 2. ]Regular
Rexpression (cmd/buildbot-app/command/command.go) +
link:#ff546918-c124-4027-80f4-2f7f004a5e2d[Listing 3. ]Thank You!
(cmd/buildbot-app/on_issue_comment_event.go) +
link:#7e20ddaf-a6d1-4644-9334-9e88612e01a6[Listing 4. ]Get PR and check
mergability (cmd/buildbot-app/on_issue_comment_event.go) +
link:#28dfa0fd-f6c8-402d-a1c5-3ee210e0a9f8[Listing 5. ]Test: Get PR and
check mergability (cmd/buildbot-app/on_issue_comment_event_test.go) +
link:#71d672ba-5e8f-49b5-808f-5ae85756cdbe[Listing 6. ]Server interface
