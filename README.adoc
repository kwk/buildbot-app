...
link:#51f7364e-64fa-45a6-8852-94857272dbc2[Listing 1. ]Command structure
(cmd/buildbot-app/command/command.go) +
link:#2e113f8e-5af4-4eaa-bd90-4af1386fd42a[Listing 2. ]Regular
Rexpression (cmd/buildbot-app/command/command.go) +
link:#3e9179a7-91eb-4f16-9d19-eb6168ab97bc[Listing 3. ]Thank You!
(cmd/buildbot-app/on_issue_comment_event.go) +
link:#efeecb79-8bc9-4466-84e4-104e0447bc15[Listing 4. ]Get PR and check
mergability (cmd/buildbot-app/on_issue_comment_event.go) +
link:#f374b417-b2f0-4d27-8fca-b682457970f9[Listing 5. ]Test: Get PR and
check mergability (cmd/buildbot-app/on_issue_comment_event_test.go) +
link:#dc40d61d-efda-4dcd-85f3-44d8406da190[Listing 6. ]Server interface
